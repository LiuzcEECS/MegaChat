...
module.exports = {
    getNameByChatId: getNameByChatId,
    getMemberByChatId: getMemberByChatId,
    getMessageByUsername: getMessageByUsername,
    getInformationByUsername: getInformationByUsername,
    getFriendsByUsername: getFriendsByUsername,
    getRequestByUsername:getRequestByUsername,
    getRequestSentByUsername:getRequestSentByUsername,
    getChatsByUsername: getChatsByUsername,
    getPasswordByUsername: getPasswordByUsername,
    getInformationByChatId:getInformationByChatId,
    getIdByUsername: getIdByUsername,
    isExistUsername: isExistUsername,
    regNewUser: regNewUser,
    setPasswordByUsername: setPasswordByUsername,
    setBgByUsername:setBgByUsername,
    setFriendsByUsername:setFriendsByUsername,
    setRequestByUsername:setRequestByUsername,
    setRequestSentByUsername:setRequestSentByUsername,
    setMessageByUsername: setMessageByUsername,
    setNameByChatId: setNameByChatId,
    setChatsByUsername: setChatsByUsername,
    setMemberByChatId:setMemberByChatId,
    newChat:newChat
}
